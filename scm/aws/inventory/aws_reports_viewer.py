...
class AWSReportsViewer:
    """Analizador de Genera graficos HTML"""
    ...
    def analyze(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "message": "Herramienta 30 - Genera graficos HTML"
        }
...
def main():
    parser = argparse.ArgumentParser(description='Genera graficos HTML')
