...
class RDSComparator:
    """Analizador de Compara instancias RDS"""
    ...
    def analyze(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "region": self.region,
            "tool": "RDS Comparator",
            "message": "Herramienta 23 - Compara instancias RDS"
        }
...
def main():
    parser = argparse.ArgumentParser(description='Compara instancias RDS')
    ...
    analyzer = RDSComparator(profile=args.profile, region=args.region)
    ...
    if args.output == 'json':
        ...
        if EXPORT_MANAGER_AVAILABLE:
            ...
            manager.export_json(result, 'rds_comparator')
    else:
