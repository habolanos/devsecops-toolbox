...
| 2026-09-09 | **1.7.8** | UpdateEngine: soporte para action add/update/remove en variables (scope Release) + template pipe_cd_add_variable_datadogscriptpermision.yaml |
| 2026-09-08 | **1.7.7** | Template pipe_cd_reorder_5: exact_match true para excluir pipelines sin los 5 stages exactos |
