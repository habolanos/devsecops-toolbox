...
|---|---|---|---|
| 2026-04-27 | 1.6.5 | Pestaña Charts en Excel de Health Score: 4 gráficos embebidos (P1 Stacked Bar composición score, P2 Donut distribución ratings, P3 Grouped Bar DORA CI vs CD, P5 Scatter score vs uso con cuadrantes de priorización). Fix normalize_org en 3 scripts. Flag --run-inventory con spinner dinámico. Grupo health en tools.py | `azdo_pipeline_health_score.py`, `cicd_inventory_ci_detailed.py`, `cicd_inventory_cd_detailed.py`, `tools.py`, `README.md` |
